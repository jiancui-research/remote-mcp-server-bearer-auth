...
import { type DescopeErrorResponse, DescopeErrorResponseSchema } from "../schemas/descope.js";
...
export function registrationHandler(provider: DescopeMcpProvider): Hono {
	const app = new Hono();
